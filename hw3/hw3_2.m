a = imread('C:\Users\gaexp\OneDrive\Documents\Digital Image Processing\Homework\HW3\DIP2017_hw3\input2.bmp');
r = size (a,1);
c = size (a,2);
ah1 = uint8(zeros (r,c));
ah2 = uint8(zeros (r,c));
...
a1 = (mean(std(double(a(2016,(1:25),:)))));
...
bh = hsv2rgb(bh);
imwrite(bh,'C:\Users\gaexp\OneDrive\Documents\Digital Image Processing\Homework\HW3\output2.bmp');
figure, imshow(bh)
